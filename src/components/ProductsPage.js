...
const WHATSAPP = 'https://wa.me/995500100470'
const FACEBOOK = 'https://facebook.com/tarinoks'
...
function ProductsPage({ product, onBack }) {
  ...
  const name = product.name[langKey] || product.name.en
        ...
        <div className="det-grid">
          ...
          <div className="det-info">
            <div className="det-badges">
              ...
              <span className={`det-badge-stock ${product.inStock ? 'det-badge-stock--in' : 'det-badge-stock--out'}`}>
            ...
            <div className="det-price">
              <span className="det-price-sym">₾</span>
              <span className="det-price-val">{product.price.toLocaleString()}</span>
            </div>

            <div className="det-desc-box">
              <div className="det-desc-label">{t.desc}</div>
              <p className="det-desc-text">{desc}</p>
            </div>

            <div className="det-actions">
              <a href={`${WHATSAPP}?text=${waMessage}`} target="_blank" rel="noopener noreferrer" className="det-btn det-btn--wa">
              ...
              <a href={FACEBOOK} target="_blank" rel="noopener noreferrer" className="det-btn det-btn--fb">
