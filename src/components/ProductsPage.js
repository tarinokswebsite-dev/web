        ...
        <div className="det-grid">
          ...
          <div className="det-info">
            ...
            <div className="det-actions">
              <a href={waHref} target="_blank" rel="noopener noreferrer" className="det-btn det-btn--wa">
              ...
              <a href={links.facebook} target="_blank" rel="noopener noreferrer" className="det-btn det-btn--fb">
